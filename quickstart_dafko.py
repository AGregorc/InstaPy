...
tags = ['luxury','motivation', 'luxurylife', 'dubai', 'lamborghini', 'summer', 'travelling']
other_tags = ['first',  'eye', 'lifestyle', 'buisness', 'wildlife', 'ig_today', 'likelike', 'forests', 'love', 'green', 'sky', 'tbt', 'pretty', 'selfie']
...
locations = [
    ...
    '16011059/vrhnika/', '240101335/kavarna-rog/',
...
def start_session():
    ...
    with smart_run(session):
        ...
        session.follow_user_following(['thevjayas'], amount=30, randomize=False, sleep_delay=60, interact=False)
        ...
        # session.unfollow_users(amount=10, nonFollowers=True, unfollow_after=42 * 60 * 60)
        session.like_by_feed(amount=14, randomize=True, interact=True)
